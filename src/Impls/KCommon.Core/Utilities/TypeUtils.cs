...
namespace KCommon.Core.Utilities
{
    ...
    public static class TypeUtils
    {
        ...
        public static T ConvertType<T>(object value)
        {
            ...
            if (typeConverter1.CanConvertFrom(value.GetType())) return (T) typeConverter1.ConvertFrom(value);

            var typeConverter2 = TypeDescriptor.GetConverter(value.GetType());
            if (typeConverter2.CanConvertTo(typeof(T))) return (T) typeConverter2.ConvertTo(value, typeof(T));
